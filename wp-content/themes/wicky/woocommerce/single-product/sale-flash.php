...
$product_sale_label = isset($wicky_settings['product-sale-label']) && !empty($wicky_settings['product-sale-label']) ? $wicky_settings['product-sale-label'] : esc_html__('Sale','wicky');
?>
<?php if(isset($wicky_settings['product-sale']) && $wicky_settings['product-sale']) : ?>
