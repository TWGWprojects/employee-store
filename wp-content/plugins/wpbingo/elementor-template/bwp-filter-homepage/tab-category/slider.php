...
if( $category ){ 	
	...
	$numberposts = (int)$numberposts;
?>
<div class="bwp-filter-homepage slider <?php echo esc_attr($layout);?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>">
	<div class="box-content">
		<div class="bwp-filter-heading">
			<div class="category-tab-nav">
				...
				<a class="button-category" href="#"><?php  echo esc_html__("all category","wpbingo") ?></a>
			</div>
		</div>
		<div class="bwp-filter-content">
			...
			<div class="content-product-list">
				<div class="content products-list grid slick-carousel row" data-item_row="<?php echo esc_attr($item_row); ?>" data-dots="<?php echo esc_attr($show_pag);?>" data-nav="<?php echo esc_attr($show_nav);?>" data-columns4="<?php echo $columns4; ?>" data-columns3="<?php echo $columns3; ?>" data-columns2="<?php echo $columns2; ?>" data-columns1="<?php echo $columns1; ?>" data-columns="<?php echo $columns; ?>">
