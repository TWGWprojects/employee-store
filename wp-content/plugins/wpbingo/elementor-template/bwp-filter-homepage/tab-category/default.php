...
if( $category ){	
	...
	$cat_selected = '';	
?>
<div class="bwp-filter-homepage tab-category-default <?php echo esc_attr($class); ?>" data-class_col = "<?php echo esc_attr($class_col); ?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>">
				...
				<div class="item-product <?php echo $class_col; ?>">
					...
					<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
						...
						<div class="products-content">
							<h3 asdsfs class="product-title"><a href="<?php esc_url(the_permalink()); ?>"><?php esc_html(the_title()); ?></a></h3>
