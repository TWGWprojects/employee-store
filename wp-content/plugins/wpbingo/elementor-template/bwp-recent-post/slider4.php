				...
				<div class="post-inner style">
						...
						<a href="<?php the_permalink(); ?>" aria-hidden="true">
							<?php
								if( has_post_thumbnail() ) :
									the_post_thumbnail( 'wicky-portfolio-image', array( 'alt' => get_the_title() ) );
								else :
					...
					<div class="post-content">
						...
						<?php if (wicky_get_config('archives-author')) { ?>
							<span class="entry-meta-link"><?php echo esc_html__("by","wpbingo") ?><?php the_author_posts_link(); ?></span>
						<?php } ?>
