                            ...
                            <div class="ocwma_cover_div">
                                <table class="ocwma_data_table">
                                    ...
                                    <tr>
                                        <th>MAX Address</th>
                                        <td>
                                            <input type="number" name="ocwma_max_adress" value="<?php if(!empty(get_option( 'ocwma_max_adress' ))){ echo get_option( 'ocwma_max_adress' ); }else{ echo "3";} ?>" >
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="ocwma_cover_div">
                                <table class="ocwma_data_table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="ocwma_head_title" value="<?php if(!empty(get_option( 'ocwma_head_title' ))){ echo get_option( 'ocwma_head_title' ); }else{ echo "Add Billing Address";} ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Button Title for Shipping</th>
                                        <td>
                                            <input type="text" name="ocwma_head_title_ship" value="<?php if(!empty(get_option( 'ocwma_head_title_ship' ))){ echo get_option( 'ocwma_head_title_ship' ); }else{ echo "Add Shipping Address";} ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Font size</th>
                                        <td>
                                            <input type="text" name="ocwma_font_size" value="<?php if(!empty(get_option( 'ocwma_font_size' ))){ echo get_option( 'ocwma_font_size' ); }else{ echo "15";} ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Font color</th>
                ...
                if( current_user_can('administrator') ) { 
                    if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'ocwma_save_option'){
                        if(!isset( $_POST['ocwma_nonce_field'] ) || !wp_verify_nonce( $_POST['ocwma_nonce_field'], 'ocwma_nonce_action' ) ){
                            ...
                            update_option('ocwma_max_adress',  sanitize_text_field( $_REQUEST['ocwma_max_adress'] ), 'yes');
                            update_option('ocwma_head_title',  sanitize_text_field( $_REQUEST['ocwma_head_title'] ), 'yes');
                            update_option('ocwma_head_title_ship',  sanitize_text_field( $_REQUEST['ocwma_head_title_ship'] ), 'yes');
                            update_option('ocwma_font_size',  sanitize_text_field( $_REQUEST['ocwma_font_size'] ), 'yes');
