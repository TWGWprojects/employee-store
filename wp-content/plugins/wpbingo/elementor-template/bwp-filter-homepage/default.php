...
if( $category && !is_array( $category ) ){
	...
	if($attribute_taxonomies){
		...
		$atributes = '';
?>
<div class="bwp-filter-homepage <?php echo esc_attr($class); ?>" data-class_col = "<?php echo esc_attr($class_col); ?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>" data-atributes="<?php echo esc_attr($atributes); ?>">
	...
	<div class="products_loadmore" <?php if($numberposts >= $total) echo 'style="display:none;"' ?>>
		<button type="button" class="btn btn-default loadmore" name="loadmore">
			...
			<span><?php echo esc_html__('View More', 'wpbingo'); ?></span>
		</button>
