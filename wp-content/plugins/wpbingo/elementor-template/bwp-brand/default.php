	...
	<div id="<?php echo esc_attr( $widget_id ) ?>" class="bwp-brand <?php echo esc_attr($layout); ?>">
		...
		<?php }?>
		<div class="slider slick-carousel" data-nav="<?php echo esc_attr($show_nav);?>" data-columns4="<?php echo $columns4; ?>" data-columns3="<?php echo $columns3; ?>" data-columns2="<?php echo $columns2; ?>" data-columns1="<?php echo $columns1; ?>" data-columns="<?php echo $columns; ?>">	
			<?php 
