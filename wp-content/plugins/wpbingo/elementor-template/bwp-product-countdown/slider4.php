							...
							<div class="products-content">
								...
								<div class="product-button">
									<div class="button-style">
										<?php
										if(function_exists("wicky_woocommerce_template_loop_add_to_cart")){
											wicky_woocommerce_template_loop_add_to_cart();
										}
										if(function_exists("wicky_add_loop_wishlist_link")){
											wicky_add_loop_wishlist_link();
										}
										if(function_exists("wicky_quickview")){
											wicky_quickview();
										}
										?>
									</div>
