...
function add_menu_admin(){
	...
	add_submenu_page( 'wpbingo', esc_html__( 'Theme Options', 'wpbingo' ), esc_html__( 'Theme Options', 'wpbingo' ), 'manage_options', 'themes.php?page=wicky_settings');
	...
	add_submenu_page( 'wpbingo', esc_html__( 'Slider', 'wpbingo' ), esc_html__( 'Slider', 'wpbingo' ), 'manage_options', 'edit.php?post_type=bwp_slider');
	add_submenu_page( 'wpbingo', esc_html__( 'Tabs Group', 'wpbingo' ), esc_html__( 'Tabs Group', 'wpbingo' ), 'manage_options', 'edit-tags.php?taxonomy=tabs_group');
	add_submenu_page( 'wpbingo', esc_html__( 'Tab Content', 'wpbingo' ), esc_html__( 'Tab Content', 'wpbingo' ), 'manage_options', 'edit.php?post_type=bwp_tab');
}

function bwp_info_area_notice(){
	echo '<h2>'. esc_html__('Welcome to Wpbingo Farmework', 'wpbingo').'</h2>';
